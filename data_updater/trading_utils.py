...
def get_clob_client():
    ...
    if key is None:
        print("Environment variable 'POLY_PK' cannot be found")
        return None
...
def approveContracts():
    ...
    wallet = web3.eth.account.from_key(os.getenv("POLY_PK"))
    ...
    for address in ['0x4bFb41d5B3570DeFd03C39a9A4D8dE6Bd8B8982E', '0xC5d563A36AE78145C45a50134d48A1215220f80a', '0xd91E80cF2E7be2e162c6513ceD06f1dD0dA35296']:
        ...
        signed_usdc_txn = web3.eth.account.sign_transaction(raw_usdc_txn, private_key=os.getenv("POLY_PK"))
        ...
        signed_ctf_approval_tx = web3.eth.account.sign_transaction(raw_ctf_approval_txn, private_key=os.getenv("POLY_PK"))
    ...
    signed_txn_2 = web3.eth.account.sign_transaction(raw_txn_2, private_key=os.getenv("POLY_PK"))
    ...
    signed_txn_3 = web3.eth.account.sign_transaction(raw_txn_3, private_key=os.getenv("POLY_PK"))
